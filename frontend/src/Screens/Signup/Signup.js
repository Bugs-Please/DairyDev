    ...
    if (password !== confirmPassword) {
      ...
      if (role === '3') {
        const res = await axios.post(
          'http://localhost:8081/api/registerenrolluserorg1',
          data
        );
        console.log(res);
      ...
      if (role === '2') {
        const res = await axios.post(
          'http://localhost:8082/api/registerenrolluserorg2',
          data
        );
        console.log(res);
        if (res.data.status === 'pass') {
      ...
      if (role === '4') {
        const res = await axios.post(
          'http://localhost:8083/api/registerenrolluserorg3',
          data
        );
        console.log(res);
        if (res.data.status === 'pass') {
      ...
      if (role === '5') {
        const res = await axios.post(
          'http://localhost:8084/api/registerenrolluserorg4',
          data
        );
        console.log(res);
        if (res.data.status === 'pass') {
              ...
              <div className="form-row">
                ...
                <div className="container">
                  ...
                  <div className="row mt-3">
                    <a
                      href="/phone-signup"
                      className="btn btn-block btn-outline-none rounded-3 text-black text-decoration-none text-primary"
                    >
